...
public class ImprovedBottomLocalityChecker implements OWLAxiomVisitor{
	...
	private Set<OWLEntity> globalEntities;// we don't count any solutions containing global entities (don't really need to make any changes to the ListProcessor)
