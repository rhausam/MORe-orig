...
public class MOReReasoner implements OWLReasoner {
	...
	public void processInputOntology() throws OWLOntologyCreationException {
		...
		manager.addAxioms(ontology, root_ontology.getRBoxAxioms(true));
	...
	public void statisticsOriginalOntology(OWLOntology ontlgy) {
		...
		LogOutput.print("Original relevant ontology axioms: "
				+ (ontlgy.getTBoxAxioms(true).size() + ontlgy.getRBoxAxioms(
						true).size()));
		int n = 0;
		ELKAxiomVisitor visitor = new ELKAxiomVisitor();
		for (OWLAxiom ax : ontlgy.getTBoxAxioms(true)) {
			ax.accept(visitor);
			if (visitor.isInFragment())
				n++;
		}
		for (OWLAxiom ax : ontlgy.getRBoxAxioms(true)) {
			ax.accept(visitor);
			if (visitor.isInFragment())
				n++;
		}
	...
	private void filterOntology() throws OWLOntologyCreationException {
		...
		LogOutput.print("Signature original: "
				+ root_ontology.getSignature(true).size());
		...
		filteredAxioms.addAll(root_ontology.getTBoxAxioms(true));
		filteredAxioms.addAll(root_ontology.getRBoxAxioms(true));
	...
	private boolean checkSatisfiability(OWLClassExpression c) {
		...
		try {
			OWLReasoner auxOWLReasoner = OWL2ReasonerManager.createOWL2ReasonerInstance(
					botModExtractor.extractAsOntology(
							signature,
							IRI.create("http://org.semanticweb.more.orechallenge/moduleForSatisfiability")),
							OWL2REASONERID);
	...
	public Node<OWLClass> getBottomClassNode() {
		...
		default:
			LogOutput.printAlways("Classification not computed yet: getBottomClassNode");
			//return null;
	...
	public Node<OWLDataProperty> getBottomDataPropertyNode() {
		...
		return new OWLDataPropertyNode(manager.getOWLDataFactory().getOWLBottomDataProperty());
	}

	@Override
	public Node<OWLObjectPropertyExpression> getBottomObjectPropertyNode() {
		LogOutput.printNotSupported("Not supported: getBottomObjectPropertyNode");
		//return null;
		//return new OWLObjectPropertyNode();
		return new OWLObjectPropertyNode(manager.getOWLDataFactory().getOWLBottomObjectProperty());
	}
	...
	public NodeSet<OWLClass> getDisjointClasses(OWLClassExpression ce)
		...
		LogOutput.printNotSupported("Not supported: getDisjointClasses. Returning explicit disjoint classes.");
		//return null;
	...
	public NodeSet<OWLObjectPropertyExpression> getDisjointObjectProperties(
			...
			throws InconsistentOntologyException, FreshEntitiesException,
			ReasonerInterruptedException, TimeOutException {
		LogOutput.printNotSupported("Not supported: getDisjointObjectProperties");
		//return null;
	...
	public Node<OWLDataProperty> getEquivalentDataProperties(
			...
			FreshEntitiesException, ReasonerInterruptedException {
		LogOutput.printNotSupported("Not supported: getEquivalentDataProperties");
		//return null;
		return new OWLDataPropertyNode();
	}
	...
	public Node<OWLObjectPropertyExpression> getEquivalentObjectProperties(
			...
			throws InconsistentOntologyException, FreshEntitiesException,
			ReasonerInterruptedException, TimeOutException {
		LogOutput.printNotSupported("Not supported: getEquivalentObjectProperties");
		//return null;
		return new OWLObjectPropertyNode();
	}
	...
	public NodeSet<OWLNamedIndividual> getInstances(OWLClassExpression arg0,
			...
			ReasonerInterruptedException, TimeOutException {
		//TODO
		LogOutput.printNotSupported("Not supported: getInstances"); //Many messages???
		// for getInstances...
		return new OWLNamedIndividualNodeSet(); 
		//return null;
	}
	...
	public Node<OWLObjectPropertyExpression> getInverseObjectProperties(
			...
			throws InconsistentOntologyException, FreshEntitiesException,
			ReasonerInterruptedException, TimeOutException {
		LogOutput.printNotSupported("Not supported: getInverseObjectProperties");
		//return null;
		return new OWLObjectPropertyNode();
	}
	...
	public NodeSet<OWLClass> getSubClasses(OWLClassExpression arg0, boolean direct)
		...
		default:
			LogOutput.printAlways("Classification not computed yet: getSubClasses");
			//return null;
			return new OWLClassNodeSet();
		}
	...
	public NodeSet<OWLClass> getSuperClasses(OWLClassExpression arg0,
		...
		default:
			LogOutput.printAlways("Classification not computed yet: getSuperClasses");
			//return null;
			return new OWLClassNodeSet();
		}
	...
	public Node<OWLClass> getTopClassNode() {
		...
		default:
			LogOutput.printAlways("Classification not computed yet: getTopClassNode");
			//return null;
	...
	public Node<OWLClass> getUnsatisfiableClasses()
		...
		default:
			LogOutput.printAlways("Classification not computed yet: getUnsatisfiableClasses");
			//return null;
			return new OWLClassNode();
		}
	...
	public boolean isConsistent() throws ReasonerInterruptedException,
		...
		default:
			LogOutput.printAlways("Classification not computed yet: isConsistent");
			return true;
		}
	...
	public boolean isEntailed(OWLAxiom arg0)
		...
		if (arg0 instanceof OWLSubClassOfAxiom) {
			...
			if (!subClass.isAnonymous() && !superClass.isAnonymous())
				...
				LogOutput.printNotSupported("Not supported: isEntailed (not atomic classes)");
				return false;
			}
		} else {
			LogOutput.printNotSupported("Not supported: isEntailed (not subclassof)");
			return false;
		}
	}
	...
	public void precomputeInferences(InferenceType... inferenceTypes)
		...
		if (requiredInferences.contains(InferenceType.CLASS_HIERARCHY))
			...
			LogOutput.printNotSupported("Not supported precomputeInferences different from InferenceType.CLASS_HIERARCHY");
	}
