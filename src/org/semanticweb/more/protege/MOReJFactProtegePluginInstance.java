...
/**
 * MORe Pellet
 * Entry point for Protege reasoner plugin (i.e. Proteg Factory). 
 ...
 *
 */
public class MOReJFactProtegePluginInstance extends AbstractProtegeOWLReasonerInfo {
	
	protected final OWLReasonerFactory factory = new MOReReasonerFactory(OWL2ReasonerManager.JFACT);
