...
public class OWL2ReasonerManager {
	...
	public final static int JFACT = 2;
	
	public final static String[] reasoner_name = {"HermiT", "Pellet", "JFact"};
	
	//public static String currentReasonerName = "HermiT";
	
	public static OWLReasoner createOWL2ReasonerInstance(
			OWLOntology onto, int reasonerID){
