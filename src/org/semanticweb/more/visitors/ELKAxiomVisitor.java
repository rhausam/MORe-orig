...
public class ELKAxiomVisitor implements OWLFragmentVisitor {
	// this class checks whether an axiom is or not supported by the reasoner
	// ELK
	...
	public void visit(OWLSubClassOfAxiom axiom) {
		...
		// if the subclass in the axiom is not EL we do not need to check the
		// superclass
	...
	public void visit(OWLEquivalentClassesAxiom axiom) {
		// We turn this OWLEquivalentClassesAxiom into a set of
		// OWLSubClassOfAxiom and then use
		// a new ELAxiomVisitor to visit them until we find one that is not EL
		Set<OWLSubClassOfAxiom> subClassOfAxioms = axiom
				.asOWLSubClassOfAxioms();

		// We walk through the set of OWLSubClassOfAxiom with the help of an
		// iterator
	...
	public void visit(OWLSubObjectPropertyOfAxiom axiom) {
		isSupportedByELK = !(axiom.getSubProperty().isAnonymous())
				&& !(axiom.getSuperProperty().isAnonymous());// no inv(R)
																// expressions
																// allowed
	}
	...
	public void visit(OWLSubPropertyChainOfAxiom axiom) {
		...
		isSupportedByELK = isSupportedByELK
				&& !(axiom.getSuperProperty().isAnonymous());
	}

	public void visit(OWLSubDataPropertyOfAxiom axiom) {
		// isSupportedByELK = !(axiom.getSubProperty().isAnonymous()) &&
		// !(axiom.getSuperProperty().isAnonymous());//no inv(R) expressions
		// allowed
	...
	public void visit(OWLDataPropertyDomainAxiom axiom) {
		// isSupportedByELK = !(axiom.getProperty().isAnonymous());
		// if (isSupportedByELK){
		// ELKClassExpressionVisitor classExpVisitor = new
	...
	public void visit(OWLHasKeyAxiom axiom) {
		// isSupportedByELK = true;
		// for (OWLPropertyExpression<?,?> prop :
		// axiom.getPropertyExpressions()){
		// isSupportedByELK = isSupportedByELK && !(prop.isAnonymous());
		// }
		// if (isSupportedByELK){
		// ELKClassExpressionVisitor classExpVisitor = new
	...
	protected class ELKClassExpressionVisitor implements
		...
		public void visit(OWLObjectSomeValuesFrom exp) {
			...
			isSupportedByELK = (!propertyExp.isAnonymous())
					&& this.isSupportedByELK();
		}
