...
public class ELAxiomVisitor implements OWLAxiomVisitor {
	...
	public void visit(OWLEquivalentClassesAxiom axiom) {
		...
		// We walk through the set of OWLSubClassOfAxiom with the help of in
		// iterator
	...
	public void visit(OWLSubObjectPropertyOfAxiom axiom) {
		isEL = !(axiom.getSubProperty().isAnonymous())
	...
	public void visit(OWLHasKeyAxiom axiom) {
		isEL = true;
		axiom.getPropertyExpressions().stream().forEach((prop) -> {
			isEL = isEL && !(prop.isAnonymous());
		});
		if (isEL) {
			ELClassExpressionVisitor classExpVisitor = new ELClassExpressionVisitor();
	...
	protected class ELClassExpressionVisitor implements
